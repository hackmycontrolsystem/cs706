...
def download(bug):
  ...
  print "status: ", remove_html(status)
  print "Reported: ", remove_html(reported)
  print "Modified: ", remove_html(modified)
  print "Component: ", remove_html(component)
  print "Version: ", remove_html(version)
  print "Platform: ", remove_html(platform)
  print "Importance: ", remove_html(importance)
  print "Flags: ", remove_html(flags)
  print "CC_list: ", remove_html(cc_list)
  print "Cpmments: ", comments
  print "Bug: ", bug
...
def get_attachments(data):
  ...
  for attempt in attempts:
    ...
    loc = http.get("https://bugzilla.redhat.com/" + patch_id).count('\n')
