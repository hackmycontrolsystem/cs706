...
def StructOpt():
    if request.method == 'GET':
        ...
        for i in range(0,int(atomList_values)):
            ...
            atomlist += "),";
            num = i+1;
            atomNameStr += "X" + str(num) + " " + request.form['type_atom'+str(i)] + "\n";
        ...
        pot_file = "/home/" + app.config["BARDEEN_USERNAME"] + "/USIT/dropbox_app/potentialFile.txt"; #request.form['pot_file'];
        ...
        potentialFileName = request.form['pot_file'];
        potentialFileName = potentialFileName[potentialFileName.rfind('/')+1:];
        ...
        if (structure == "Defect"):
            ...
            solidfile = "/home/" + app.config["BARDEEN_USERNAME"] + "/USIT/dropbox_app/POSCAR"; #request.form['solidfile'];
        ...
        with open(os.path.join(path, solidFileName), 'wb') as temp_file:
        ...
        sftp.put(resource_path(os.path.join('output', potentialFileName)), "/home/" + app.config["BARDEEN_USERNAME"] + "/USIT/dropbox_app/"+potentialFileName)
           
        sftp.put(resource_path(os.path.join('output', "POSCAR")), "/home/" + app.config["BARDEEN_USERNAME"] + "/USIT/dropbox_app/POSCAR")
